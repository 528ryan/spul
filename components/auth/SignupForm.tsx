  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        {googlePending ? 'Redirecionando...' : 'Cadastrar com Google'}
      </button>
      ...
      <form action={handleEmailSubmit} className="space-y-4">
        ...
        >
          ...
          {emailPending ? 'Criando conta...' : 'Criar conta'}
        </button>
      </form>
      ...
      <div className="space-y-3 text-center">
        <p className="text-sm text-muted">
          Já tem conta?{' '}
          <Link href="/login" className="text-accent hover:text-text-2 transition-colors">
            Entre
          </Link>
        </p>
        <p className="text-xs text-muted-2">
          Ao criar uma conta você concorda com nossos{' '}
          <span className="text-muted">Termos de Uso</span>.
        </p>
      </div>
    </div>
  )
